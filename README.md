...
4. Access the WordPress web application
   ...
   <img src="docs/images/wordpress.png" alt="nessus_scan" style="width:auto;height:600px;">
...
14. Open terminal in Kali, start zaproxy
    ...
    <img src="docs/images/zaproxy.png" alt="zaproxy" style="width:auto;height:600px">
...
22. Initiate a Network Scan against LKE worker nodes
    ...
    <img src="docs/images/nessus_scan.png" alt="nessus_scan" style="width:auto;height:600px">
